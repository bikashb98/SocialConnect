...
const config = {
  ...
  inlineDatasources: {
    db: {
      url: {
        fromEnvVar: "SHADOW_DATABASE_URL",
        value: null,
      },
    },
  },
  ...
  parsed: {
    SHADOW_DATABASE_URL:
      (typeof globalThis !== "undefined" &&
        globalThis["SHADOW_DATABASE_URL"]) ||
